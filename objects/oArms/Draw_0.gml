...
draw_sprite_ext(sSwordArm, swordSubimage, swordX + swordOffsetX * image_xscale, swordY, image_xscale, image_yscale, lastWeapon == Weapon.SWORD ? (image_angle + 90*image_xscale) : 0, c_white, image_alpha)
